...
class Ui_MainWindow(QWidget):
    ...
    def __init__(self, mainwindow, name='main'):
        super(Ui_MainWindow, self).__init__()
        self.setupUi(mainwindow)
        qssStyle = self.readQss('./gui/QSS/my.qss')
    ...
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(50, 200, 701, 461))
        ...
        self.OrgImg = QtWidgets.QGraphicsView(self.LeftFrame)
        ...
        self.ResultList.setGeometry(QtCore.QRect(50, 290, 221, 151))
        ...
        self.Title.setGeometry(QtCore.QRect(220, 30, 361, 51))
        font = QtGui.QFont()
        font.setFamily("华文细黑")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.HeatmapLabel.setText(_translate("MainWindow", "疾病热图："))
        ...
        self.menu.setTitle(_translate("MainWindow", "数据集信息"))
        self.menu_2.setTitle(_translate("MainWindow", "模型信息"))
